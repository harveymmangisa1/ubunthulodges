              ...
              <div className="space-y-10">
                ...
                <div className="group cursor-default">
                  ...
                  <div className="pl-9 space-y-1">
                    <p className="text-stone-500 font-light">+265 995 87 90 30 <span className="text-[9px] uppercase ml-2 text-stone-300 tracking-tighter">(Reservations)</span></p>
                    <p className="text-stone-500 font-light">+265 995 87 90 30 <span className="text-[9px] uppercase ml-2 text-stone-300 tracking-tighter">(Direct)</span></p>
                  </div>
                </div>
